...
- alternate screenによる現在Sessionの隔離、PageUp / PageDownによるviewport移動、過去表示中の位置と
  ...
  terminal復元。
- 過去表示中のdraft保持、boundedな入力履歴、Session選択、`/help`・`/sessions`・`/provider`・`/model`・`/effort`・
