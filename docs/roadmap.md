...
- 段階（実装順序）:
  ...
  8. Increment 69（予定）: `web_search`(Sonar)をsubagent化する。
  9. Increment 70（予定）: `tool:read|write|edit|bash`のsame-identity overrideを扱う。
- architectureは
